 ...
 */
?>        
<body id="lightbox2-display" <?php print $section_class; ?>>
  <div id="container" class="<?php print $classes; ?>">
    ...
    <div id="footerLightbox">
      <div class="content clearfix">
        <div class="logo-site-name">
          <?php if ($site_logo): ?><span id="logo"><?php print $site_logo; ?></span><?php endif; ?>
        </div>     
        <div class="slogan-site">
          <?php print theme( 'image', path_to_theme( ) . '/images/live.png', 'Live inspired...', 'Live inspired...' );?>
        </div>
        <div class="close-text">
        	<p><?php print t( 'CLOSE WINDOW' ); ?></p>
        </div>     
      </div>
    </div>
  </div> <!-- /container -->
